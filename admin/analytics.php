...
<body>
    ...
    <section class="dashboard">
        ...
        <div class="top">
            ...
            <!-- <p>Food Donate</p> -->
            <p  class ="logo" >Feed <b style="color: #06C167; ">TheNeed</b></p>
             <p class="user"></p>
...
<script>
      <?php
            ...
            $female=$ro2['count'];
            $male=$row['count'];
            $q3="SELECT count(*) as count FROM food_donations where location=\"vizianagaram\"";
            $res3=mysqli_query($connection, $q3);
            $ro3=mysqli_fetch_assoc($res3);
            $vizianagaram=$ro3['count'];
            $q4="SELECT count(*) as count FROM food_donations where location=\"visakhapatanam\"";
            $res4=mysqli_query($connection, $q4);
            $ro4=mysqli_fetch_assoc($res4);
            $visakhapatanam=$ro4['count'];
            $q5="SELECT count(*) as count FROM food_donations where location=\"srikakulam\"";
            $res5=mysqli_query($connection, $q5);
            $ro5=mysqli_fetch_assoc($res5);
            $srikakulam=$ro5['count'];
            

    ?>
var xValues = ["Male","Female"];
var xplace=["vizianagaram","visakhapatanam","srikakulam"];
var yplace=[<?php echo json_encode($vizianagaram,JSON_HEX_TAG);?>,<?php echo json_encode($srikakulam,JSON_HEX_TAG);?>,<?php echo json_encode($visakhapatanam,JSON_HEX_TAG);?>];
